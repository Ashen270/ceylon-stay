                ...
                <div className='flex items-center gap-5 '>
                    {authUser ? (
                        <>
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger className='flex items-center focus:outline-none gap-2'>
                                    <Avatar>
                        ...
                        <>
                            <Link
                                ...
                                <Button
                                    variant={'outline'}
                                    className='text-white bg-transparent border hover:bg-white hover:text-primary-700 rounded-lg'
                                >Sign In
                                </Button>
                            </Link>
                            <Link
